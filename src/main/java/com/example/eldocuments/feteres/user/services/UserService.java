...
public class UserService {
    ...
    public Integer addDetails(Integer userId, CreateUserDetailsInfoParams params) {
        ...
        userDetailsInfo.setWorkshopName(params.getWorkshopName());
        userDetailsInfo.setWorkshopNumber(params.getWorkshopNumber());
    ...
    public void uploadPhoto(Integer userId, MultipartFile file) throws IOException {
